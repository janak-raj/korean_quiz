...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Learn /</span> Grammar</h4>

              <!-- Accordion -->
              <h5 class="mt-4">Grammars</h5>
              <div class="row">
                    ...
                    <div class="card accordion-item active">
                      ...
                      >
                        <div class="accordion-body">
                          ...
                          <a href=""><button type="button" class="btn btn-dark" style="float:right;">Proceed</button></a>
                          </div>
                        </div>
                      </div>
                    </div>
