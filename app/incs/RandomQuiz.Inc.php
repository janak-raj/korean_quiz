...
<div class="content-wrapper">
                  ...
                  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Quiz /</span> Random</h4>

<!-- Accordion -->
<h5 class="mt-4">Random</h5>
                     <div class="row">
                        <div class="col-lg-12 mt-4 order-0">
                           <div class="card">
                              <div class="d-flex align-items-end row">
                                 <!-- start Quiz button -->
                <div class="quiz_box_container">
