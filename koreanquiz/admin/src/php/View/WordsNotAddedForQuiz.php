<?php
class WordsNotAddedForQuiz extends DatabaseConfig {
	public function getWords() {
		$fetchSql = "SELECT * FROM `words` WHERE `isAddedToQuiz` = 'Not Added'";
                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="btn-group mt-3" role="group" aria-label="Basic example" style="width: 100%;">
                              ...
                              if ($get['isAddedToQuiz'] == "Added") {
                                ...
                                <button type="submit" value="'.$get['wordId'].'_frq" name="remove-from-quiz" class="btn btn-dark" title="Remove from Quiz">
                                ...
                                echo '
                                <form action="src/php/WordAdapter.php" method="POST">
                                <button type="submit" value="'.$get['wordId'].'_frq" name="add-to-quiz" class="btn btn-success" title="Add to Quiz">
